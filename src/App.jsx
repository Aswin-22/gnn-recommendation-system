        ...
        <div className="container">
          <div className="content-container">
            ...
            <p className="description">
              ...
              the following columns: user_id, track_id, rating. Your data will
              be processed using graph neural networks (GNNs) and homomorphic
          ...
          <div className="progress-section">
            ...
            <p className="progress-description">
              ...
              the embeddings using homomorphic encryption to protect your
              privacy.
            </p>
          </div>
        </div>
